/*  Atelier Photo - Travaux Pratiques UV MI01
 Copyright (C) 2005, 2018 S. Bonnet, Université de Technologie de Compiègne
...
void process_image_asm(UINT biWidth, UINT biHeight,
  BYTE *img_src, BYTE *img_temp1, BYTE *img_temp2, BYTE *img_dest);

void process_image_simd(UINT biWidth, UINT biHeight,
  BYTE *img_src, BYTE *img_temp1, BYTE *img_temp2, BYTE *img_dest);
 ...
 *
 */
void process_image_C(UINT biWidth, UINT biHeight, 
  BYTE *img_src, BYTE *img_temp1, BYTE *img_temp2, BYTE *img_dest)
{
  unsigned int c, n;
  unsigned int x, y;
